  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa aliquam corrupti dicta odio similique minima officiis nemo, ratione sapiente sit vel molestiae. Tempore aliquid perferendis error enim distinctio, quis sit maiores itaque necessitatibus, qui cupiditate nihil. Neque placeat deleniti ipsum labore quia ab qui ullam. Id a delectus totam laudantium!</p>
            {/* stats */}

            <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
                <div>
                    <h3 className='text-3xl font-bold'>800+</h3>
                    <p text-base>Book Listing</p>
                </div>
                <div>
                    <h3 className='text-3xl font-bold'>550+</h3>
                    <p text-base>Register Users</p>
                </div>
                <div>
                    <h3 className='text-3xl font-bold'>1200+</h3>
                    <p text-base>PDF Downloads</p>
                </div>
            </div>
